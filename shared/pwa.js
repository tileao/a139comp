(function(){
  ...
  function serviceWorkerConfig(){
    ...
    if (path.includes('/cata/') || path.includes('/adc/') || path.includes('/pouso-offshore/') || path.includes('/decolagem-offshore/') || path.includes('/dropdown/') || path.includes('/flight-preview/')) return { url: '../sw.js', scope: '../' };
  ...
  function launchIconPath(){
    ...
    if (path.includes('/cata/') || path.includes('/adc/') || path.includes('/wat/') || path.includes('/rto/') || path.includes('/pouso-offshore/') || path.includes('/decolagem-offshore/') || path.includes('/dropdown/') || path.includes('/importar-voo/') || path.includes('/flight-preview/')) return '../assets/icon-192.png';
  ...
  function basePrefix(){
    const path = pagePath();
    if (path.includes('/cata/') || path.includes('/adc/') || path.includes('/wat/') || path.includes('/rto/') || path.includes('/dropdown/') || path.includes('/pouso-offshore/') || path.includes('/decolagem-offshore/') || path.includes('/pesos/') || path.includes('/slo/') || path.includes('/ncl/') || path.includes('/importar-voo/') || path.includes('/flight-preview/')) return '../';
    return './';
  }
