const GEOM_KEY = 'aw139_adc_geometry_v49';
    ...
    const EMBED_MODE = URL_PARAMS.has('embed') && URL_PARAMS.get('embed') !== '0' && URL_PARAMS.get('embed') !== 'false';
    ...
    function loadCurrentChart() {
      ...
      document.getElementById('vizSubtitle').textContent = EMBED_MODE ? `${base.id} • ${runway.label} • ${chart.label}` : `${base.id} • ${runway.label} • ${chart.label} • toque na carta para abrir em tela cheia.`;
    }
